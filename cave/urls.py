...
urlpatterns = patterns('',
    ...
    url(r'^searchBouteillesBaseAjax', views.searchBouteillesBaseAjax, name='searchBouteillesBaseAjax'),
    url(r'^searchBouteillesCaveAjax', views.searchBouteillesCaveAjax, name='searchBouteillesCaveAjax'),
